module TS.IJQuery.MVP.Form {
    export class CheckBoxValueFormJQueryPresenter extends AbstractFormJQueryPresenter<TS.MVP.Form.IFormModel<boolean, any>> {
        ...
        _doLoad(model: TS.MVP.Form.IFormModel<boolean, any>) {
            super._doLoad(model);
