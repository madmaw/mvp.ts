module TS.IJQuery.MVP.Form {
    export class InnerTextValueFormJQueryPresenter<ValueType> extends AbstractFormJQueryPresenter<TS.MVP.Form.IFormModel<ValueType>> {
        ...
        _doLoad(model: TS.MVP.Form.IFormModel<any>) {
            super._doLoad(model);
