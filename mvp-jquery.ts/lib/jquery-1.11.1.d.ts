...
interface JQueryPromise<T> {
     ...
     */
    fail(failCallbacks1?: JQueryPromiseCallback<any>, ...failCallbacks2: JQueryPromiseCallback<any>[]): JQueryDeferred<T>;
    /**
...
interface JQueryDeferred<T> extends JQueryPromise<T> {
    ...
    fail(failCallbacks1?: JQueryPromiseCallback<any>, ...failCallbacks2: JQueryPromiseCallback<any>[]): JQueryDeferred<T>;
    fail(failCallbacks1?: JQueryPromiseCallback<any>[], ...failCallbacks2: JQueryPromiseCallback<any>[]): JQueryDeferred<T>;
    fail(failCallbacks1?: JQueryPromiseCallback<any>, ...failCallbacks2: any[]): JQueryDeferred<T>;
    fail(failCallbacks1?: JQueryPromiseCallback<any>[], ...failCallbacks2: any[]): JQueryDeferred<T>;
    /**
     * Add handlers to be called when the Deferred object generates progress notifications.
     * 
